...
@pytest.mark.parametrize(
    ...
    [
        ("claude", ("CLAUDE.md", ".claude/settings.json", ".mcp.json", ".claude/commands/agentpack-review.md", ".claude/commands/agentpack-resolve.md", ".claude/commands/agentpack-skill-review.md"), False),
