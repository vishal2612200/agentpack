...
def register(app: typer.Typer) -> None:
    ...
    def doctor(
        ...
        # --- Slash commands ---
        console.print("\n[bold]Slash commands (/agentpack, /agentpack-review, /agentpack-resolve, /agentpack-skill-review, /agentpack-learn)[/]")
        for filename in ("agentpack.md", "agentpack-review.md", "agentpack-resolve.md", "agentpack-skill-review.md", "agentpack-learn.md"):
