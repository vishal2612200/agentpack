...
def register(app: typer.Typer) -> None:
    ...
    def doctor(
        ...
        # --- Slash commands ---
        console.print("\n[bold]Slash commands (/agentpack, /agentpack-review, /agentpack-audit, /agentpack-learn)[/]")
        for filename in ("agentpack.md", "agentpack-review.md", "agentpack-audit.md", "agentpack-learn.md"):
