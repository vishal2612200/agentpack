...
def _public_benchmark_markdown(
    ...
    *,
    ...
    if tested_commit:
        lines.insert(5 if version else 4, f"- tested commit: {tested_commit}")
    ...
    *,
    ...
    out.write_text(
        _public_benchmark_markdown(
            ...
            suite=suite,
            version=version,
            tested_commit=git.current_sha(root) or "",
            command=command,
        ),
        encoding="utf-8",
    )
...
# E2E commands moved to benchmark_e2e; keep imports and patch points stable.
from agentpack.commands import benchmark_e2e as _benchmark_e2e  # noqa: E402
from agentpack.commands.benchmark_e2e import (  # noqa: E402, F401
    E2ECase,
    E2EResult,
    _e2e_ab_markdown,
    _e2e_ab_metrics,
    ...
    register_e2e_commands,
)


def _grep_context(*args: Any, **kwargs: Any) -> str:
    return _benchmark_e2e._grep_context(*args, **kwargs)


def _agentpack_lite_context(*args: Any, **kwargs: Any) -> str:
    return _benchmark_e2e._agentpack_lite_context(*args, **kwargs)


register_e2e_commands(benchmark_app)
